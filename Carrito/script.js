...
function renderProductos() {
    ...
    xmlhttp.open('GET','includes/get_productos.php?sid='+Math.random(),true);
    xmlhttp.send();
}
function renderCarrito()
{
    ...
    xmlhttp.open('GET','includes/get_carrito.php?sid='+Math.random(),true);
    xmlhttp.send();
};
function anadirProducto(id)
{
    ...
    xmlhttp.open('GET','includes/add_producto.php?id='+id+'&sid='+Math.random(),true);
    xmlhttp.send();
};
function deleteProducto(id)
{
    ...
    xmlhttp.open('GET','includes/delete_producto.php?id='+id+'&sid='+Math.random(),true);
    xmlhttp.send();
};